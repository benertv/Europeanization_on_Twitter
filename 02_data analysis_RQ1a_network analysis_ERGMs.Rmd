...
summary(network_quotes ~ edges + #intercept
          ...
          nodeifactor("actor_group", levels=c(2,4,5,7)) + # sender effects
          nodeofactor("actor_group", levels=c(2,4,5,7)) + # receiver effects
          nodematch("actor_group", levels=c(2,4,5,7), diff = F) + # homophily
          nodematch("pol_leaning", levels=c(2:4,7,9:10), diff = F) + # homophily
          nodeifactor("pol_leaning", levels=c(2:4,7,9:10)) + #sender effects
          nodeofactor("pol_leaning", levels=c(2:4,7,9:10)) + # receiver effects
